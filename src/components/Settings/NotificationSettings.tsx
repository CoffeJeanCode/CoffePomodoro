import { Box, Button, Group, Select, Slider, Switch, Title } from "@mantine/core";
						...
						onChange={(evt) => {
							...
							if (checked)
								Notification.requestPermission().then((perm) => {
									if (perm === "granted") setConfigValue("notification.desktopNofitication", true);
									else setConfigValue("notification.desktopNofitication", false);
								});
						}}
					/>
				</Box>
