...
export function syncPiPTheme(doc: Document, styleKey: string, cssText: string) {
	const styleEl = doc.getElementById("pip-css");
	if (styleEl && styleEl.getAttribute("data-style-key") !== styleKey) {
		styleEl.textContent = cssText;
		styleEl.setAttribute("data-style-key", styleKey);
	}
}
