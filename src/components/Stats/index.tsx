...
import { Badge, Button, Container, Drawer, Flex, SegmentedControl, Title, Tooltip } from "@mantine/core";
...
const Stats = () => {
	...
	const maxValue = Number(reduce(max, 0, data)) / (statType === StatType.Sessions ? 1 : 60);
			...
			<Drawer opened={isOpen} position="bottom" size={400} onClose={() => setIsOpen(false)}>
				<Container>
					<Flex justify="center" align="center" gap="md">
						...
						<Tooltip label="Productivity" color="blue" position="bottom" withArrow arrowPosition="center">
					...
					<Line
						...
						data={{
							...
							datasets: [
								{
									label,
									data: statType === StatType.Sessions ? data : data.map(secondsToMinutes),
									backgroundColor: [
										"rgba(255, 99, 132, 0.2)",
										"rgba(255, 159, 64, 0.2)",
										"rgba(255, 205, 86, 0.2)",
