...
import { getCurrentWeek, isToday, startOfWeek } from "@/utils/time.util";
...
const Home = () => {
  ...
  const [startOfWeekDate, setStartOfWeekDate] = useLocalStorage({key: "startOfWeek", defaultValue: new Date()});
